...
- python config_evolution_gomobi.py criar      → Cria instância do WhatsApp  - https://go-mobi-whatsapp.onrender.com/manager
- python config_evolution_gomobi.py qrcode     → Obtém QR Code para conectar
- python config_evolution_gomobi.py status     → Verifica se está conectado
- python config_evolution_gomobi.py enviar     → Envia mensagem de teste
